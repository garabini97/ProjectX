 ...
 include  "../processa/conecta.php";
  ...
  $sql2 = $mysqli->prepare('select o.id,c.nome,car.modelo,car.placa,o.observacao,o.data_cadastro from orcamento as o ,clientes as c,carros as car where o.id_cliente = c.id and o.id_carro = car.id and c.id = ?');
